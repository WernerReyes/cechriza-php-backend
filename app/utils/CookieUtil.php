...
class CookieUtil {
     ...
     */
    public static function setJwtCookie($token, $name = 'access_token', $expiry = 3600) {
        $options = [
            'expires' => time() + $expiry,
            'path' => '/',
    ...
    public static function setAuthCookies($accessToken, $refreshToken) {
        ...
        $result['access'] = self::setJwtCookie($accessToken, 'access_token', 3600);
