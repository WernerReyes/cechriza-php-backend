...
--     category_id INT DEFAULT NULL, -- TODO: Delete this field if not used
...
--     CONSTRAINT fk_section_items_category FOREIGN KEY (category_id) REFERENCES categories(id_category)  -- TODO: Delete this constraint if not used
-- ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
-- -- ==========================================
